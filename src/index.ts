#!/usr/bin/env node
// Shopify MCP Server — Production Entry Point
...
async function loadAllTools(client: ShopifyClient) {
  const toolGroups = await Promise.all([
    ...
    // === Round 4: Moat Deepening — 80+ modules ===
    import("./tools/checkout.js").then((m) => m.getTools(client)),
    import("./tools/customer_payment_methods.js").then((m) => m.getTools(client)),
    import("./tools/delivery_profiles.js").then((m) => m.getTools(client)),
    import("./tools/discount_codes.js").then((m) => m.getTools(client)),
    import("./tools/file_uploads.js").then((m) => m.getTools(client)),
    import("./tools/gift_card_adjustments.js").then((m) => m.getTools(client)),
    import("./tools/inventory_levels.js").then((m) => m.getTools(client)),
    import("./tools/translations.js").then((m) => m.getTools(client)),
    import("./tools/order_editing.js").then((m) => m.getTools(client)),
    import("./tools/payment_terms.js").then((m) => m.getTools(client)),
    import("./tools/returns.js").then((m) => m.getTools(client)),
    import("./tools/selling_plans.js").then((m) => m.getTools(client)),
    import("./tools/subscription_contracts.js").then((m) => m.getTools(client)),
    import("./tools/web_pixels.js").then((m) => m.getTools(client)),
    import("./tools/metafield_definitions.js").then((m) => m.getTools(client)),
    import("./tools/companies.js").then((m) => m.getTools(client)),
    import("./tools/catalogs.js").then((m) => m.getTools(client)),
    import("./tools/segments.js").then((m) => m.getTools(client)),
    import("./tools/publications.js").then((m) => m.getTools(client)),
    import("./tools/assigned_fulfillment_orders.js").then((m) => m.getTools(client)),
    import("./tools/fulfillment_constraints.js").then((m) => m.getTools(client)),
    import("./tools/order_transactions_extended.js").then((m) => m.getTools(client)),
    import("./tools/shop_locales.js").then((m) => m.getTools(client)),
    import("./tools/mobile_platform_apps.js").then((m) => m.getTools(client)),
    import("./tools/customer_merge.js").then((m) => m.getTools(client)),
    import("./tools/discount_automatic.js").then((m) => m.getTools(client)),
    import("./tools/price_rules_extended.js").then((m) => m.getTools(client)),
  ]);
...
async function main() {
  ...
  if (!storeDomain || !accessToken) {
    ...
    console.error("Copy .env.example to .env and fill in your Shopify credentials.");
    console.error("  SHOPIFY_STORE_DOMAIN — e.g. mystore.myshopify.com");
    console.error("  SHOPIFY_ACCESS_TOKEN — Admin API access token (starts with shpat_)");
    process.exit(1);
  }
...
// === Build output schema (minimal Zod for structuredContent) ===
